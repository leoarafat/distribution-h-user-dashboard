...
const AddProduct = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    formData.append(
      "expireDate",
      JSON.stringify(moment(values?.expireDates)?.format("YYYY-MM-DD"))
    );
      ...
      >
        <div className="col-span-6">
          ...
          <div className="grid grid-cols-12 gap-6">
            <Form.Item label="Weight" name="weight" className="col-span-6">
              <Input size="large" placeholder="Weight" />
            </Form.Item>

            <Form.Item label="Brand" name="brand" className="col-span-6">
        ...
        <div className="col-span-6">
          <div className="grid grid-cols-12 gap-6">
            ...
            <Form.Item
              ...
              style={{ marginBottom: 0 }}
            >
              <Input type="number" size="large" placeholder="Discount price" />
            </Form.Item>
            ...
            <Form.Item
              ...
              style={{ marginBottom: 0 }}
            >
              <Select placeholder="Select a Subcategory" size="large">
                {subCategoryData &&
